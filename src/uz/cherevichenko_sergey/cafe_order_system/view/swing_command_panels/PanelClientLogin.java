...
public class PanelClientLogin extends JPanel {
    ...
    public PanelClientLogin(SendButtonListener listener) {
        ...
        // Заголовок
        titleLabel = new JLabel("Авторизация клиента");
        ...
        addField(formPanel, gbc, 2, "Пароль:", passwordField);
