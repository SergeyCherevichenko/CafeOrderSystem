...
public class PanelAddIndexForDishRemoveToMenu extends JPanel {
    ...
    public PanelAddIndexForDishRemoveToMenu(SendButtonListener listener) {
        this.listener = listener;
        setLayout(new BorderLayout());

        // Заголовок
        titleLabel = new JLabel("Удалть блюдо из меню");
        ...
        gbc.gridx = 0;
        gbc.gridy = 0;
        indexLabel = new JLabel("Номер блюда:");
